...
NOTES:
- You'll get a lot of complier warnings, but this is just due to how the original codebase was made. They are just warnings, but there shouldn't be any errors that stops the repo from compiling.
