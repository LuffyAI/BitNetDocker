...
def setup_gguf():
    ...
    #Patched right here to add no-deps to avoid dependency conflicts
    run_command([sys.executable, "-m", "pip", "install", "3rdparty/llama.cpp/gguf-py", "--no-deps"], log_step="install_gguf")
