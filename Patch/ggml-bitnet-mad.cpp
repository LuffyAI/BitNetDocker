...
void ggml_vec_dot_i2_i8_s_Nx1(int n, float * s, size_t bs, const void * vx, size_t bx, const void * vy, size_t by, int nrc) {
    ...
    for (int col = 0; col < nrc; col += PARALLEL_SIZE) {
        ...
        // Patch here: fix y_col pointer calculation
        // Original line: int8_t * y_col = y + col * by;
        // Changed by LuffyAI because clang complains about discarding 'const' qualifier
